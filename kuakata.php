...
<div class="place">
			...
			<h2><u>Kuakata</u></h2>
			<button class="btn btn-primary" role="button" id="KuaBtn" onclick="myFunction1()">Add To favorite</button>
			...
			<img src="img/kuakata2.jpg" height="320" width="450" alt="cox's bazar" align="right">
