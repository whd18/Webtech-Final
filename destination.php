...
<body>
	...
	<div id="div1" style="margin: 5px,5px,5px,5px;">
		
		<br/><br/>
		<h1 style="text-align: center;">Cox's Bazar</h1>
			<label><b>Chittagong , Bangladesh.</b></label>
			<img src="img/cox.jpg" height="200" width="300" alt="cox's bazar" align="left" style="margin: 10px 10px 10px 10px;">
				<P style="margin: 10px 10px 10px 10px; ">Cox's Bazar is a town, a fishing port and district headquarters in Bangladesh. The beach in Cox's Bazar is an unbroken 125 km sandy sea beach with a gentle slope, one of the world's longest.<br/><br/> It is located 150 km south of the industrial port Chittagong. Cox's Bazar is also known by the name Panowa, whose literal translation means "yellow flower." Its other old name was "Palongkee".
	...
	<div id="div2" style="margin: 5px,5px,5px,5px;">
		<br/><br/>
		<h1 style="text-align: center;">Sundarban</h1>
		  <label><b>Khulna , Bangladesh.</b></label>
		<img src="img/sundarban.jpg" height="200" width="300" alt="cox's bazar" align="left" style=" margin: 10px 10px 10px 10px;">
			<p style="margin: 10px 10px 10px 10px; ">The Sundarbans is a natural region comprising southern Bangladesh and a small part in Eastern India. It is the largest single block of tidal halophytic mangrove forest in the world.The Sundarbans covers approximately 10,000 square kilometres (3,900 sq mi) most of which is in Bangladesh with the remainder in India. The Sundarbans is a UNESCO World Heritage Site.<br/><br/>
			Sundarbans South, East and West are three protected forests in Bangladesh. This region is densely covered by mangrove forests, and is the largest reserves for the Bengal tiger. 
					<div id="footer">
						<p><a href="sundarban.php">Details</a></p>
	...
	<div id="div3" style="margin: 5px,5px,5px,5px;">
	<h1 style="text-align: center;">Sylhet</h1>
		<label><b>Sylhet , Bangladesh.</b></label>
		<img src="img/sylhet.jpg" height="200" width="auto" alt="cox's bazar" align="left" style=" margin: 10px 10px 10px 10px;">
			<p style="margin: 10px 10px 10px 10px; ">
				...
				Sylhet is a prominent Islamic spiritual centre and home to numerous Sufi shrines. Sylhet has a reputation as the Spiritual Capital of Bangladesh. It hosts the 14th century mausoleums of Shah Jalal and Shah Paran. The Sylhet municipality was constituted during the British Raj in 1867. It was part of the Bengal Presidency and the Assam Province. 
					<div id="footer">
