...
<body>
	...
	<div class="place">
		...
		<h1 >Cox's Bazar</h1>
			...
			<img src="img/cox.jpg" alt="cox's bazar" >
				...
				The modern Cox's Bazar derives its name from Captain Hiram Cox (died 1799), an officer of the British East India Company.Cox was appointed Superintendent of Palongkee </p>
					
			<a href="coxs.php" class="btn btn-info" role="button">Details</a>
	...
	<div class="place">
		...
		<img src="img/sundarban.jpg"  alt="cox's bazar" >
			...
			Sundarbans South, East and West are three protected forests in Bangladesh. This region is densely covered by mangrove forests. </p>
			
			 <a href="coxs.php" class="btn btn-info" role="button">Details</a>
			<!-- <p class=""><a href="sundarban.php">Details</a></p> -->
