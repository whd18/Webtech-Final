...
<div class="place">
			...
			<button class="btn btn-primary" role="button" id="BogaBtn" onclick="myFunction1()">Add To favorite</button>
...
<div class="place">
			...
			<button class="btn btn-primary" role="button" id="NilBtn" onclick="myFunction2()">Add To favorite</button>
	...
	<div class="place">
			...
			<button class="btn btn-primary" role="button" id="NilaBtn" onclick="myFunction3()">Add To favorite</button>
