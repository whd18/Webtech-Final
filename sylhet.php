...
<head>
	<title> Sylhet</title>
	<br/><br/>
	<h1 style="text-align: center;">Visit Sylhet</h1>
	<style>
		.place {
		   float: left;
		   margin: 10px;
...
<div class="place" style="text-align: justify;font:bold 20px Arial, Helvetica;">
			...
			<h2 style="text-align: center;"><u>Lalakhal (The blue Canal)</u></h2>
			<img src="img/lalakhal.jpg" height="200" width="auto" alt="cox's bazar" align="left" style="margin: 5px 10px 5px 10px;">
			<img src="img/lalakhal2.jpg" height="200" width="400" alt="cox's bazar" align="right" style="margin: 5px 5px 5px 5px;">
...
<div class="place" style="text-align: justify;font:bold 20px Arial, Helvetica;">
			...
			<h2 style="text-align: center;"><u>Bisnakandi</u></h2>
			<img src="img/bisanakandi2.jpg" height="200" width="auto" alt="cox's bazar" align="left" style="margin: 5px 10px 5px 10px;">
			<img src="img/bisanakandi.jpg" height="200" width="400" alt="cox's bazar" align="right" style="margin: 5px 5px 5px 5px;">
...
<div class="place" style="text-align: justify;font:bold 20px Arial, Helvetica;">
			...
			<h2 style="text-align: center;"><u>Madhabpur Lake</u></h2>
			<img src="img/madhabpur2.jpg" height="200" width="auto" alt="cox's bazar" align="left" style="margin: 5px 10px 5px 10px;">
			<img src="img/madhabpur.jpg" height="200" width="auto" alt="cox's bazar" align="right" style="margin: 5px 5px 5px 5px;">
...
<div class="place" style="text-align: justify;font:bold 20px Arial, Helvetica;">
			...
			<h2 style="text-align: center;"><u>Srimangal City</u></h2>
			<img src="img/srimangal.jpg" height="200" width="auto" alt="cox's bazar" align="left" style="margin: 5px 10px 5px 10px;">
			<img src="img/srimangal2.jpg" height="200" width="350" alt="cox's bazar" align="right" style="margin: 5px 5px 5px 5px;">
	...
	<div class="place" style="text-align: justify;font:bold 20px Arial, Helvetica;">
			...
			<h2 style="text-align: center;"><u>HumHum Waterfall</u></h2>
			<img src="img/humhum.jpg" height="200" width="auto" alt="cox's bazar" align="left" style="margin: 5px 10px 5px 10px;">
			<img src="img/humhum2.jpg" height="200" width="400" alt="cox's bazar" align="right" style="margin: 5px 5px 5px 5px;">
