...
<div class="place">
			...
			<button class="btn btn-primary" role="button" id="lalBtn" onclick="myFunction1()">Add To favorite</button>
...
<div class="place">
			...
			<button class="btn btn-primary" role="button" id="BisBtn" onclick="myFunction2()">Add To favorite</button>
...
<div class="place">
			...
			<button class="btn btn-primary" role="button" id="MadBtn" onclick="myFunction3()">Add To favorite</button>
...
<div class="place">
			...
			<button class="btn btn-primary" role="button" id="SriBtn" onclick="myFunction4()">Add To favorite</button>
	...
	<div class="place">
			...
			<button class="btn btn-primary" role="button" id="HumBtn" onclick="myFunction5()">Add To favorite</button>
